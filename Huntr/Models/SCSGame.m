...
{
    if (self.endDate == nil || self.startDate == nil) return SCSGameStatusNotStarted;
    ...
    if (nowTimeInterval < startTimeInterval) return SCSGameStatusNotStarted;
    if (nowTimeInterval > endTimeInterval) return SCSGameStatusCompleted;
    if (nowTimeInterval < endTimeInterval && nowTimeInterval >= startTimeInterval) return SCSGameStatusInProgress;
